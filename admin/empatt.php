...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-6">
          <h4><?php echo $logged_in_user['Employee_Name']; ?></h4>
  ...
  <table class="table table-striped table-bordered">
    ...
    <tbody>
      <tr>
        <th scope="row"><?php echo $logged_in_user['created_at']; ?></th>
        <td><?php echo $logged_in_user['Login_Time']; ?></td>
        <td><?php echo $logged_in_user['out_time_b']; ?></td>
        <td><?php echo $logged_in_user['in_time_b']; ?></td>
        <td><?php echo $logged_in_user['out_time_l']; ?></td>
        <td><?php echo $logged_in_user['in_time_l']; ?></td>
        <td><?php echo $logged_in_user['out_time_t']; ?></td>
        <td><?php echo $logged_in_user['in_time_t']; ?></td>
        <td><?php echo $logged_in_user['Logout_Time']; ?></td>
        <td><?php echo $logged_in_user['total_hrs']; ?></td>
      </tr>
    </tbody>
  </table>
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-1"> 
        <div class="btn-group">
          <a class="btn btn-primary" href="timelist.php?Employee_Id=<?php echo $Employee_Id;?>" role="button">Back</a>
        </div>
      </div>
    </div>
  </div>
